...
\begin{document}
    ...
    \input{chapters/NonLocalMean.tex}
    \input{chapters/BilateralFilter.tex}
    \input{chapters/AnisotropicFiltering.tex}
    % \input{chapters/BM3D.tex}
